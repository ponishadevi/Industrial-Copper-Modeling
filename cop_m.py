...
st.set_page_config(page_title="Industrial Copper Modeling | By Ponishadevi",
                   layout="wide",
...
<div style='text-align:center'>
    ...
    <p style='color: #4d4d4d;'>Use this application to predict the selling price or status of copper items based on various parameters.</p>     
</div>
""", unsafe_allow_html=True)
...
with tab1:    
        ...
        st.write("Fill in the following details to predict the selling price:")
        ...
        if submit_button and flag==0:
            ...
            st.write(f'## :green[Predicted selling price:]:{np.exp(new_pred):.2f}')
            
with tab2: 
        st.write("### Predict Status")
        st.write("Fill in the following details to predict the status:")
...
st.write( f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by Ponishadevi</h6>', unsafe_allow_html=True )  
